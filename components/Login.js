...
export default function Login() {
  ...
  return (
    <div className="z-50 fixed inset-0">
      <div className="backdrop-blur-md flex justify-center items-center fixed inset-0 bg-gray-800 bg-opacity-50 overflow-y-auto h-full w-full">
        <div className="bg-blue-800 rounded-xl h-[15rem] w-[20rem] p-2 flex justify-center items-center">
